...
const players = dataLines
  ...
  .map(cols => {
    ...
    return {
      ...
      // raw CSV values for Supabase extra columns
      _curBat: curBat, _potBat: potBat, _curBowl: curBowl, _potBowl: potBowl,
    };
  });
