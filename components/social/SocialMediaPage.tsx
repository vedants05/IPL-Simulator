...
export default function SocialMediaPage(props: SocialMediaPageProps) {
  ...
  const platformFont = activePlatform === "x"
    ...
    : activePlatform === "reddit"
      ...
      : '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif';
  return <div style={{ fontFamily: platformFont }} className={`fixed-external-ui relative min-h-full overflow-y-auto ${platformShell}`}><div className="relative mx-auto min-h-full max-w-[1400px] px-3 sm:px-5">{switcher}<div className={`grid grid-cols-1 gap-5 pt-0 lg:grid-cols-[190px_minmax(0,680px)_240px] ${activePlatform === "reddit" ? "lg:gap-4" : activePlatform === "instagram" ? "lg:gap-8" : ""}`}>
