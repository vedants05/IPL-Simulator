...
import { getHomeStadium, getHomeStadiumName } from "../data/pitchCurator";
...
const STATIC_TEAMS: Team[] = [
  {
    ...
    homeGround: getHomeStadiumName("MI"),
    city: "Mumbai",
    totalPurse: 12000,
    spentAmount: 0,
  ...
  },
  {
    ...
    homeGround: getHomeStadiumName("CSK"),
    city: "Chennai",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    homeGround: getHomeStadiumName("KKR"),
    city: "Kolkata",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    primaryColor: "#DA1818",
    secondaryColor: "#D4A017",
    homeGround: getHomeStadiumName("RCB"),
    city: "Bengaluru",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    homeGround: getHomeStadiumName("DC"),
    city: "Delhi",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    shortName: "SRH",
    primaryColor: "#F26522",
    secondaryColor: "#e5b842",
    homeGround: getHomeStadiumName("SRH"),
    city: "Hyderabad",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    homeGround: getHomeStadiumName("PBKS"),
    city: "Mohali",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    homeGround: getHomeStadiumName("RR"),
    city: "Jaipur",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    primaryColor: "#1B2133",
    secondaryColor: "#ffffff",
    homeGround: getHomeStadiumName("GT"),
    city: "Ahmedabad",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  },
  {
    ...
    primaryColor: "#e21f26",
    secondaryColor: "#0057e2",
    homeGround: getHomeStadiumName("LSG"),
    city: "Lucknow",
    totalPurse: 12000,
    spentAmount: 0,
    remainingPurse: 12000,
  ...
  try {
    ...
    const mapped = data.map((row: any): Team => {
      ...
      return {
        ...
        homeGround: getHomeStadium(row.id)?.name ?? row.home_ground,
        city: row.city,
        totalPurse,
        spentAmount: 0,
