...
export const PERSON_DYNAMICS_SEEDS: PersonDynamicsSeed[] = [
  ...
  // --- Emerging Player-Player Developing Bonds (Youngster <-> Senior) ---
  playerPair("Angkrish Raghuvanshi", "Rinku Singh", "franchise_teammates", 46, "Emerging youngster sharing the Kolkata Knight Riders dugout and batting group with senior finisher Rinku.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerPair("Angkrish Raghuvanshi", "Venkatesh Iyer", "franchise_teammates", 50, "Young top-order batter learning middle-order tempo from senior KKR compatriot Venkatesh Iyer.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerPair("Ramandeep Singh", "Rinku Singh", "franchise_teammates", 52, "Developing camaraderie in Kolkata Knight Riders lower-order finishing unit.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerPair("Vaibhav Arora", "Harshit Rana", "pace_tandem", 55, "Young pace partnership sharing new ball and middle overs duties at Kolkata Knight Riders.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerPair("Suyash Sharma", "Sunil Narine", "spin_twins", 54, "Young mystery spinner observing and learning craft from senior maestro Narine at KKR.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerPair("Sameer Rizvi", "Ruturaj Gaikwad", "mentor_protege", 45, "Young big-hitting recruit guided by captain Gaikwad in Chennai Super Kings setup.", "https://www.iplt20.com/teams/chennai-super-kings"),
  playerPair("Sameer Rizvi", "Shivam Dube", "franchise_teammates", 48, "Emerging spin-hitter learning middle-overs boundary striking alongside Dube at CSK.", "https://www.iplt20.com/teams/chennai-super-kings"),
  playerPair("Mukesh Choudhary", "Deepak Chahar", "pace_tandem", 52, "Fellow left-and-right new-ball swing partners competing and learning within CSK pace unit.", "https://www.iplt20.com/teams/chennai-super-kings"),
  playerPair("Tushar Deshpande", "Deepak Chahar", "pace_tandem", 58, "Indian seam combination operating together across multiple CSK campaigns.", "https://www.iplt20.com/teams/chennai-super-kings"),
  playerPair("Naman Dhir", "Suryakumar Yadav", "mentor_protege", 48, "Emerging top-order batter learning 360-degree shot-making from senior mentor Suryakumar at MI.", "https://www.mumbaiindians.com/"),
  playerPair("Naman Dhir", "Tilak Varma", "franchise_teammates", 54, "Next-generation young Indian batting core sharing the Mumbai Indians top order.", "https://www.mumbaiindians.com/"),
  playerPair("Anshul Kamboj", "Jasprit Bumrah", "mentor_protege", 45, "Young domestic seam sensation learning elite execution alongside Bumrah at Mumbai Indians.", "https://www.mumbaiindians.com/"),
  playerPair("Dewald Brevis", "Suryakumar Yadav", "mentor_protege", 52, "Young overseas power-hitter absorbing batting intent and practice routines from Suryakumar at MI.", "https://www.mumbaiindians.com/"),
  playerPair("Nehal Wadhera", "Tilak Varma", "franchise_teammates", 58, "Young middle-order pair frequently batting together in high-pressure chases for Mumbai Indians.", "https://www.mumbaiindians.com/"),
  playerPair("Dhruv Jurel", "Sanju Samson", "mentor_protege", 58, "Young wicketkeeper-batter learning leadership and pressure absorption from captain Samson at RR.", "https://www.rajasthanroyals.com/"),
  playerPair("Kuldeep Sen", "Sandeep Sharma", "pace_tandem", 46, "Young express bowler learning seam control and variations from veteran Sandeep Sharma at RR.", "https://www.rajasthanroyals.com/"),
  playerPair("Yashasvi Jaiswal", "Riyan Parag", "franchise_teammates", 62, "Longstanding age-group peers sharing Rajasthan Royals top-and-middle order development.", "https://www.rajasthanroyals.com/"),
  playerPair("Ayush Badoni", "KL Rahul", "mentor_protege", 55, "Young finisher learning match-building awareness and temperament from captain KL Rahul at LSG.", "https://www.lucknowsupergiants.in/"),
  playerPair("Mayank Yadav", "Mohsin Khan", "pace_tandem", 50, "Young Indian pace battery sharing rehab and opening attack responsibilities at Lucknow Super Giants.", "https://www.lucknowsupergiants.in/"),
  playerPair("Ayush Badoni", "Ravi Bishnoi", "franchise_teammates", 56, "Young domestic peers who arrived at LSG in the inaugural season and bonded closely.", "https://www.lucknowsupergiants.in/"),
  playerPair("Anuj Rawat", "Rajat Patidar", "franchise_teammates", 52, "Young Indian domestic batting teammates developing together in RCB middle order.", "https://www.royalchallengers.com/"),
  playerPair("Mahipal Lomror", "Rajat Patidar", "franchise_teammates", 54, "Complementary left-and-right middle-overs batting partners for Royal Challengers Bengaluru.", "https://www.royalchallengers.com/"),
  playerPair("Vijaykumar Vyshak", "Mohammed Siraj", "pace_tandem", 50, "Local Karnataka pacer learning international intensity from pace spearhead Siraj at RCB.", "https://www.royalchallengers.com/"),
  playerPair("Nitish Kumar Reddy", "Abhishek Sharma", "franchise_teammates", 58, "Young domestic all-round stars spearheading Sunrisers Hyderabad dynamic new era.", "https://www.sunrisershyderabad.in/"),
  playerPair("Abdul Samad", "Abhishek Sharma", "franchise_teammates", 55, "Longtime Sunrisers Hyderabad young batting group peers who rose through the ranks together.", "https://www.sunrisershyderabad.in/"),
  playerPair("Umran Malik", "Bhuvneshwar Kumar", "mentor_protege", 52, "Raw express pacer mentored on discipline and seam presentation by veteran Bhuvneshwar at SRH.", "https://www.sunrisershyderabad.in/"),
  playerPair("Sai Sudharsan", "Rahul Tewatia", "franchise_teammates", 52, "Top-order anchor and lower-order finisher sharing pressure situations for Gujarat Titans.", "https://www.gujarattitansipl.com/"),
  playerPair("R. Sai Kishore", "Sai Sudharsan", "franchise_teammates", 58, "Tamil Nadu domestic teammates sharing state dressing rooms and Gujarat Titans dugout.", "https://www.gujarattitansipl.com/"),
  playerPair("Shahrukh Khan", "Rahul Tewatia", "franchise_teammates", 54, "Twin power-hitting middle order partners combining for death-overs onslaughts at GT.", "https://www.gujarattitansipl.com/"),
  playerPair("Abishek Porel", "Rishabh Pant", "mentor_protege", 54, "Young wicketkeeper-batter mentored and backed by senior keeper-captain Pant at Delhi Capitals.", "https://www.delhicapitals.in/"),
  playerPair("Abishek Porel", "Axar Patel", "franchise_teammates", 50, "Young dynamic batter combining with senior all-rounder Axar in high-pressure chases at DC.", "https://www.delhicapitals.in/"),
  playerPair("Rasikh Salam", "Khaleel Ahmed", "pace_tandem", 48, "Emerging seam talent combining with senior left-armer Khaleel in Delhi Capitals pace attack.", "https://www.delhicapitals.in/"),
  playerPair("Kumar Kushagra", "Rishabh Pant", "mentor_protege", 44, "Young keeper-batter recruit observing Pant closely in the Delhi Capitals squad.", "https://www.delhicapitals.in/"),
  playerPair("Prabhsimran Singh", "Jitesh Sharma", "franchise_teammates", 52, "Attacking wicketkeeper-batters sharing Punjab Kings top-order and middle-order roles.", "https://www.punjabkingsipl.in/"),
  playerPair("Harpreet Brar", "Arshdeep Singh", "franchise_teammates", 58, "Punjab domestic teammates and close franchise bowling unit partners for PBKS.", "https://www.punjabkingsipl.in/"),
  playerPair("Ashutosh Sharma", "Jitesh Sharma", "franchise_teammates", 50, "Railways / domestic circuit power hitters connecting in Punjab Kings dugout.", "https://www.punjabkingsipl.in/"),

  // --- Emerging Player-Staff Developing Bonds ---
  playerStaff("Angkrish Raghuvanshi", "chandrakant-pandit", "coached", 48, "Young batter adapting to senior head coach Pandit tactical discipline and demands at KKR.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerStaff("Ramandeep Singh", "abhishek-nayar", "specialist_tutelage", 55, "Power-hitting recruit benefiting from Nayar technical guidance at the KKR high performance setup.", "https://www.iplt20.com/teams/kolkata-knight-riders"),
  playerStaff("Sameer Rizvi", "michael-hussey", "specialist_tutelage", 50, "Young power-hitter receiving initial batting coaching and shot selection guidance from Hussey at CSK.", "https://www.iplt20.com/teams/chennai-super-kings"),
  playerStaff("Naman Dhir", "kieron-pollard", "specialist_tutelage", 52, "Young batter working with Pollard on power hitting and mental resilience at Mumbai Indians.", "https://www.mumbaiindians.com/"),
  playerStaff("Nehal Wadhera", "mahela-jayawardene", "coached", 54, "Middle-order batter receiving tactical positioning and game situation coaching from Jayawardene.", "https://www.mumbaiindians.com/"),
  playerStaff("Nitish Kumar Reddy", "daniel-vettori", "coached", 58, "Emerging all-rounder given expanded responsibility under head coach Vettori at Sunrisers Hyderabad.", "https://www.sunrisershyderabad.in/"),
  playerStaff("Abishek Porel", "sourav-ganguly", "talent_champion", 55, "Young Bengal wicketkeeper backed by Director of Cricket Ganguly into the Delhi Capitals squad.", "https://www.delhicapitals.in/"),
  playerStaff("Rasikh Salam", "pravin-amre", "coached", 46, "Young seamer receiving support and team integration within the Delhi Capitals coaching group.", "https://www.delhicapitals.in/"),
];
