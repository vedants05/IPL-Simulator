...
export const OTHER_LEAGUE_RECORDS: OtherLeagueRecord[] = [
  { id: "highest-total", label: "Highest team total", value: "287/3", holder: "Sunrisers Hyderabad", detail: "vs RCB (262/7) · 15-04-2024 · M Chinnaswamy Stadium, Bengaluru (20.0 ov, 22x6)" },
  { id: "lowest-total", label: "Lowest team total", value: "49", holder: "Royal Challengers Bengaluru", detail: "vs KKR (131) · 23-04-2017 · Eden Gardens, Kolkata (9.4 ov, target 132)" },
  { id: "highest-chase", label: "Highest successful chase", value: "265/4", holder: "Punjab Kings", detail: "vs DC (264/2) · 25-04-2026 · Arun Jaitley Stadium, Delhi (18.5 ov, target 265)" },
  { id: "individual-score", label: "Highest individual score", value: "175*", holder: "Chris Gayle", detail: "175* off 66b (13x4, 17x6, SR 265.15) · RCB vs PWI · 23-04-2013 · Bengaluru", playerNames: ["Chris Gayle"] },
  { id: "bowling-figures", label: "Best bowling figures", value: "6/12", holder: "Alzarri Joseph", detail: "6/12 in 3.4 ov (econ 3.27, 14 dots) · MI vs SRH · 06-04-2019 · Hyderabad", playerNames: ["Alzarri Joseph"] },
  ...
  { id: "partnership", label: "Highest partnership", value: "229", holder: "Kohli & de Villiers", detail: "229 runs off 96b (2nd wkt) · Kohli 109 & de Villiers 129* · RCB vs GL · 14-05-2016", playerNames: ["Virat Kohli", "AB de Villiers"] },
];
